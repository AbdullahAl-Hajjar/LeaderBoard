...
public class CreateUserTest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>CreateUserTest</title>");            
            out.println("</head>");
            out.println("<body>");
             out.println("<form action=\"CreateUserTest\" method=\"post\">");
           out.println("ID<br>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Username user = usernameLogic.createEntity(request.getParameterMap());
       usernameLogic.add(user);
